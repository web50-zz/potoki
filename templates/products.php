    ...
    <div class="container">
        <div class="products-block-one__grid">
                <div class="products-block-one__grid-one" data-aos="fade-up" data-aos-delay="300"> 
                    <h3>экологичность</h3>
                    <p>
                        Используется меньше материала <br>
                        по сравнению с жесткими упаковками, <br>
                ...
                <div class="products-block-one__grid-three" data-aos="fade-up" data-aos-delay="600">
                    ...
                    <p>Компактные и легкие, что снижает затраты <br> на транспортировку и хранение</p>
                    <svg>
                        <use href="#blue_arrow"></use>
                    </svg>
                </div>
                <div class="products-block-one__grid-four" data-aos="fade-up" data-aos-delay="800">
                    <h3>Удобство <br> использования</h3>
                    <p>
                        Легкость открытия, повторного <br> закрытия и хранения
                    </p>
                </div>
                <div class="products-block-one__grid-five" data-aos="fade-up" data-aos-delay="1000">
                    <h3>Качество</h3>
                    <p>
                        Каждый этап производства и заполнения <br>
                        проходит строгий контроль качества, <br>
                        чтобы обеспечить герметичность,  <br> 
                        целостность и безопасность упаковки
                    </p>
                </div>
        </div>        
    </div>
...
<section class="products-block-two">
    <div class="products-block-two__pic">
		<img src='<?=get_template_directory_uri()?>/assets/images/products/products_big_2.webp?v=<?=$THEME_VERSION?>'  alt="" width="1680px" height="1321px"/>
	</div>
	<div class="products-block-two__content">
            <div class="container">
                <div class="products-block-two__one">
                    ...
                    <div class="products-block-two__logo" data-aos="fade-left" data-aos-delay="200">
                        <img src='<?=get_template_directory_uri()?>/assets/images/products/products_pic2.webp?v=<?=$THEME_VERSION?>'  alt="" width="407px" height="181px"/>
                    </div>
                    <div class="products-block-two__description" data-aos="fade-in" data-aos-delay="300">
                        Вода питьевая негазированная первой категории очищенная «Потоки Стилл» <br>
                        – фильтрация <br>
                        – обратный осмос <br>
                        – озон <br>
                        – УФ-облучение
                ...
                <div class="products-block-two__two">
                        <div class="products-block-two__two-item" data-aos="fade-in" data-aos-delay="200">
                                ...
                                <p>
                                    Вода из источника центрального водоснабжения поступает на первую ступень очистки. 
                                    На данном этапе происходит предварительная очистка с помощью сорбционных фильтров. 
                                    После предварительной очистки вода поступает на установку обратного осмоса.
                                </p>
                        </div>
                        <div class="products-block-two__two-item" data-aos="fade-in" data-aos-delay="400">
                                ...
                                <p>
                                    Вода после обратноосмотической установки поступает на ступень кондиционирования, 
                                    где проходит через фильтры минерализаторы. 
                                    Там она насыщается природными минералами. После минерализации происходит корректировка минерального состава насосами дозаторами.
                                </p>
                        </div>
                        <div class="products-block-two__two-item" data-aos="fade-in" data-aos-delay="600">
                                ...
                                <p>
                                    Для дезинфекции используются 3 ступени обеззараживания: с помощью ультрафиолетовых ламп, с помощью финишного озонирования 
                                    воды и повторной дезинфекции ультрафиолетовыми лампами перед розливом.
                                </p>
                        </div>
                        <div class="products-block-two__two-item" data-aos="fade-in" data-aos-delay="800">
                                ...
                                <p>
                                    На автомате по формированию пакетов 
                                    и розливу, формируется дойпак, с последующим наполнением его подготовленной водой.
                                </p>
                        </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="products-block-three__grid">
            ...
            <div class="products-block-three__description" data-aos="fade-right" data-aos-delay="400">
                <p>Производим воду под вашей торговой маркой (СТМ);</p>

                <p>Совокупная мощность производства около 50 млн дойпак пакетов в год;</p>

                <p>Современное оборудование для очистки и розлива воды, которое позволяет производить товар с улучшенными характеристиками по качеству;</p>

                <p>Есть возможность разработки индивидуального дизайна 
                и индивидуального состава воды;</p>

                <p>Наличие собственной лаборатории позволяет нам контролировать 
                качество продукции на всех этапах производства;</p>

                <p>Гарантия качества и бесперебойные поставки.</p>
            </div>
    ...
    <div class="container">
            ...
            <div class="products-block-four__grid">
                ...
                <div class="products-block-four__two-one" data-aos="fade-up" data-aos-delay="100">
                    <div class="products-block-four__two-title">
                        Мы готовы производить упаковку Дойпак <br> из дуплексной пленки разных объемов.
                    </div>
                    <div class="products-block-four__two-description">
                        <p>Материал внутреннего слоя Полиэтилентерефталат (ПЭТ), наружный слой Полиэтилен (ПЭ);</p>
                        <p>Высокая плотность и прочность;</p>
                        <p>Предназначение упаковки: для использования в быту.</p>
                    </div>
                </div>
                <div class="products-block-four__two-two" data-aos="fade-up" data-aos-delay="200">
                    <strong>Дополнительная информация:</strong><br>
                    Упаковка дойпак поставляется с недокрученным колпачком, во избежания срыва контрольного кольца, обеспечивающего гарантию целостности- контроль первого вскрытия для потребителя.
                    Герметично закрывающаяся крышка, устойчивое дно.
                    Упаковка соответствует ТУ 22.22.19-022-55257312-2024
                    Гарантийный срок хранения 12 месяцев
                    <br><br>
                    <strong>Условия доставки/самовывоза:</strong><br>
                    - Возможность доставки оптовых заказов<br>
                    - Возможность самовывоза, адрес пункта самовывоза
                </div>
            </div>
    </div>
</section>

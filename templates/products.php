    ...
    <div class="container">
        <div class="products-block-one__grid">
                <div class="products-block-one__grid-one" data-aos="fade-up" data-aos-delay="300"> 
                    ...
                    <p>
                    Для производства пакета СТИЛЛ расходуется <br>
                    в 2 раза меньше пластика, <br>
                    а объем отходов в 7 раз меньше <br>
                    по сравнению с ПЭТ-бутылкой.
                    </p>
                    <svg>
                ...
                <div class="products-block-one__grid-two" data-aos="fade-up" data-aos-delay="100">
                    <div class="products-block-one__pic-one">
                            <img src="<?=get_template_directory_uri()?>/assets/images/products/products_pic_1.webp?v=<?=$THEME_VERSION?>" alt="" />
                    </div>
                </div>
                <div class="products-block-one__grid-three" data-aos="fade-up" data-aos-delay="600">
                    <h3>КАЧЕСТВО</h3>
                    <p>
                    Мы гарантируем современные условия<br>
                    производственной среды, строгое <br>
                    соблюдение технологического процесса, <Br>
                    безопасность и качество готовой продукции.<br>    
                    <svg>
                        <use href="#blue_arrow"></use>
                    </svg>
                </div>
                <div class="products-block-one__grid-four" data-aos="fade-up" data-aos-delay="800">
                    <h3>НОВИЗНА</h3>
                    <p>
                    Рынок питьевой воды консервативен. <br>
                    Бутылками из ПЭТ и стекла заставлены <Br>
                    торговые полки. Мы предлагаем новый <br>
                    подход к повседневной потребности.
                    </p>
                    <svg>
                        <use href="#blue_arrow"></use>
                    </svg>
                ...
                <div class="products-block-one__grid-five" data-aos="fade-up" data-aos-delay="1000">
                    ...
                    рюкзаке, а пустой дойпак <br>
                    можно сложить в карман!
                    </p>
                    <svg>
                        <use href="#blue_arrow"></use>
                    </svg>
	...
	<div class="products-block-two__content">
            <div class="container">
                <div class="products-block-two__one">
                     <div class="products-block-two__header" id="pv" data-aos="fade-right" data-aos-delay="200">
                        питьевая вода
                    </div>
                ...
                <div class="products-block-two__two">
                        <div class="products-block-two__two-item" data-aos="fade-in" data-aos-delay="200">
                                ...
                                <p>
                                Исходная вода проходит через дисковый, сорбционные и мешочные фильтры, установку обратного осмоса, УФ-облучатели и станцию проточного озонирования. Качество продукта на всех этапах контролируется собственной испытательной лабораторией.
                                </p>
                        </div>
                        ...
                        <div class="products-block-two__two-item" data-aos="fade-in" data-aos-delay="800">
                                ...
                                <p>
                                После выхода из упаковочного автомата готовая продукция сканируется системой обязательной маркировки «Честный знак». Дойпаки укладываются в гофрокороба, которые затем заклеиваются и направляются на автоматический паллетайзер.
                                </p>
                        </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="products-block-three__grid">
            ...
            <div class="products-block-three__description" data-aos="fade-right" data-aos-delay="400">
                <p>Контрактное производство питьевой воды <br> и безалкогольных напитков под вашей торговой маркой в индивидуальной упаковке объемом до 1 литра</p>

                <p>
                    Персонал с обширным опытом по производству питьевой воды,<br>
                    соков, пива и крепкого алкоголя
                </p>

                <p>
                    Производство безалкогольных напитков возможно только по холодным технологиям (без варки и настаивания)
                </p>

                <p>
                    Возможно производство продуктов, подлежащих обязательной маркировке <br> ГИС МТ «Честный знак»
                </p>
            </div>
            <div class="products-block-three__description-two" data-aos="fade-right" data-aos-delay="400">
                ...
                <p>Около 2 500 м2 производственно-складских площадей и собственная испытательная лаборатория, соответствующие стандарту ISO 22000</p>
                <p>Новейшее автоматическое оборудование от ведущих производителей из России, Италии, КНР, США и других стран</p>
...
<section class="products-block-four">
    <div class="container" id="block_pack">
            ...
            <div class="products-block-four__grid">
                ...
                <div class="products-block-four__two-one" data-aos="fade-up" data-aos-delay="100">
                    <div class="products-block-four__two-description">
                        <p>Производим упаковку от 25 до 1000 мл из многослойной пленки любых термосвариваемых структур общей толщиной материала до 160 мкм</p>
                        <p>Дизайнеры, работающие с нами на постоянной основе, помогут разработать упаковку и торговую марку с чистого листа</p>
                        <p>Возможно использование пленки с предварительно нанесённой печатью или с нанесением самоклеящихся этикеток</p>
                ...
                <div class="products-block-four__two-two" data-aos="fade-up" data-aos-delay="200">
                   ...
                   <p>Может поставляться навалом в коробах или мешках</p>
                   <p>В комплекте с готовыми дойпаками поставляются колпачки для укупорки продукции покупателем после наполнения</p>
            ...
            <strong>Мы готовы к сотрудничеству!</strong><br>
            О своих идеях и предложениях пишите на <a href="mailto:sales@potoki.ru">sales@potoki.ru</a>
            </p>
        </div>
    </div>
</section>
